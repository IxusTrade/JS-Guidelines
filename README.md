...
## Dialogs
  ...
  - all dialogs must be in /assets/js/dialogs/<module name>/<dialog name>.js or in /assets/js/pages/<module name>/dialogs/<dialog name>.js
    
  ```javascript
  /assets/js/dialogs/client-request/blocked-change-form.js
  /assets/js/pages/client-request/dialogs/FilterForm.js
  ```
  ...
  - calling the dialog
   ...
   ```javascript
   IxusTrade.utils.dialog.open('dialogs.ClientRequest.EmailForm', {});
   ```
...
## Components
  ...
  - all components must be in /assets/js/components/<module name>/<dialog name>.js
  ...
  - declare all form, stores, grids and other objects used in component in the top of component body, group them by the type
...
## Storages
  ...
  - all storages must be in /assets/js/storages/<module name>/<storage name>.js
            
  ```javascript
  /assets/js/storages/inventory/inventory.js
  ```
    
  - use camelCase to naming storages
    
  ```javascript
  createInventoryInStockStore
  ```
   
  - using storage
             
   ```javascript
   storeInventoryInStock = IxusTrade.storages.inventory.createInventoryInStockStore();
   ```
